...
# define MENU_SET_LOAD         5
# define MENU_SET_SAVE         6
# define MENU_SET_RESET        7

# define MENU_SET_BACK         8
...
psp_settings_menu_init(void)
{
  ...
  psp_joystick_cursor   = INTEL.psp_joystick_cursor;
...
psp_settings_menu_validate(void)
{
  ...
  INTEL.psp_joystick_cursor  = psp_joystick_cursor;
